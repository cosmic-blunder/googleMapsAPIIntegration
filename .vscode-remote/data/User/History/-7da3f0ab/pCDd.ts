           ...
           markerCar=new google.maps.Marker(
            {position:{lat:position.coords.latitude,lng:position.coords.longitude},
                                          ...
                                          /*
                                              ...
                                              i would say we can only show the multiple marker on the map but cannot show there  direaction heading towered .
                                              Live location data required the coodinted to store to database with trip id that vehicl e 
                                          */
